import { computeBaseline, computeMultiscaleDistributedBaseline } from "./baseline.js";
import { buildPidCenterOutOrder, computeContourPid, computePidOrdering, computePidOrderingScores, computeTemporalSelfInclusion } from "./pid.js";
import { optimizeLayerOrder } from "./optimizeOrder.js";
export function computeOptimizingOrder(dataset, config) {
    ...
    if (resolved.orderingScoringMode === "sineStream") {
        const optimized = optimizeLayerOrder(dataset.layers, resolved.orderRoi, {
...
function normalizedInputOrder(dataset) {
...
function buildInsideOutOrder(layers, inputOrder) {
