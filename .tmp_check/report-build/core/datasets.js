...
function createCovidQuantileSeries(length) {
    return {
...
function assignCovidQuantile(series, quantile, index, value) {
...
function covidQuantileTarget(series, quantile) {
...
function interpolateCovidQuantileSeries(series) {
    return {
...
function covidQuantileRows(series) {
    return [series.q025, series.q10, series.q25, series.q50, series.q75, series.q90, series.q975];
}
function buildCovidLayer(abbreviation, rawCounts, counts, rawPoportion, poportion) {
